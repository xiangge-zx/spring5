...
import com.xuan.spring.A20.MyRequestMappingHandlerAdapter;
...
public class WebConfig {
    ...
    // 如果用DispatcherServlet 初始化时默认添加的足迹 并不会作为Bean
    // 1.加入RequsetMappingHandlerMapping
    @Bean
    ...
    // 2.继续加入RequestMappingHandlerAdapter 会替换掉DispatcherServlet 默认的 4个HandlerAdapter
    @Bean
